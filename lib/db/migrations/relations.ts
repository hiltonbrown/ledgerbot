...
import { user, suggestion, document, chat, message, messageV2, stream, contextFile, chatXeroContext, userSettings, xeroConnection, qaReviewRequest, vote, voteV2 } from "./schema";
...
export const chatXeroContextRelations = relations(chatXeroContext, ({one}) => ({
	chat: one(chat, {
...
export const qaReviewRequestRelations = relations(qaReviewRequest, ({one}) => ({
