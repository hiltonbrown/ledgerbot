...
const PureSpreadsheetEditor = ({ content, saveContent }: SheetEditorProps) => {
  ...
  const columns = useMemo(() => {
    const rowNumberColumn = {
      ...
      cellClass:
        "border-t border-r border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-950 dark:text-zinc-50",
      headerCellClass:
        "border-t border-r border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 dark:text-zinc-50",
    };
    ...
    const dataColumns = Array.from({ length: MIN_COLS }, (_, i) => ({
      ...
      width: 120,
      cellClass: cn(
        "border-zinc-300 border-t bg-white dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-50",
        {
          "border-l": i !== 0,
        }
      ),
      headerCellClass: cn(
        "border-zinc-300 border-t bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50",
        {
          "border-l": i !== 0,
        }
      ),
