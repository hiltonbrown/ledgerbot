				...
				<div className="space-y-6">
					<div className="flex items-center justify-between rounded-lg border bg-muted/30 p-4">
						<div className="space-y-0.5">
							<Label className="text-base font-semibold" htmlFor="system-enabled">
								Agent system
							</Label>
							...
							<div className="space-y-2">
								...
								<div className="flex items-center justify-between">
									...
									<Switch
										...
										id="doc-bills"
										onCheckedChange={(checked) =>
											setSupportedDocTypes((prev) => ({ ...prev, bills: checked }))
										}
									/>
								</div>
							</div>
					...
					>
						...
						<SettingRow description="Default export format" label="Report format">
					...
					>
						...
						<SettingRow description="System logging verbosity" label="Logging level">
