...
const complianceChecklist = [
  {
    ...
    description:
      "Agent cross-checked GST codes for 128 transactions this fortnight.",
    complete: true,
  },
  {
    id: 2,
    ...
    <div className="space-y-10">
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <Card>
          <CardHeader className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground text-sm">
              Agent responses are grounded in official Australian legislation
              and require human confirmation for high-risk calls.
            </p>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border bg-muted/50 p-4">
                ...
                <p className="text-muted-foreground text-xs">
                  “This insight is general in nature and should not replace
              ...
              <div className="rounded-lg border bg-muted/50 p-4">
                ...
                <p className="text-muted-foreground text-xs">
                  Reviewed by <strong>Lex & Co</strong> – coverage includes GST,
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <p className="text-muted-foreground text-sm">
              Tailor when to inject disclaimers, escalate to humans and which
              jurisdiction the agent references.
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between rounded-md border bg-muted/40 p-4">
              <div>
                <p className="font-medium text-sm">
                  Include legal disclaimer automatically
                </p>
                <p className="text-muted-foreground text-xs">
                  Display the approved disclaimer on every response unless
                  suppressed manually.
                </p>
              </div>
              <Switch
                checked={autoDisclaimers}
                onCheckedChange={setAutoDisclaimers}
              />
            </div>
            <div className="flex items-center justify-between rounded-md border bg-muted/40 p-4">
              <div>
                ...
                <p className="text-muted-foreground text-xs">
                  Require human review for payroll, superannuation or penalties
                  above $5k.
                </p>
              </div>
              <Switch
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-muted-foreground text-xs">
                Default focus is Australia. Update to customise disclaimers and
      ...
      <Card>
        <CardHeader className="flex flex-col gap-1">
          ...
          <p className="text-muted-foreground text-sm">
            Sync compliance milestones with the forecasting agent to balance
            tax, payroll and BAS requirements.
          </p>
        </CardHeader>
        <CardContent className="space-y-4">
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <p className="text-muted-foreground text-sm">
              Identify the legislation and rulings referenced most often by the
              agent this week.
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="rounded-lg border bg-card p-4 shadow-sm">
              ...
              <p className="mt-2 text-sm">
                Agent outputs are informational. Confirm advice with a
                registered tax agent before acting on high-risk matters.
              </p>
            </div>
          </CardContent>
        </Card>
